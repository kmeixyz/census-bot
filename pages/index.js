...
export default function Home() {
  ...
  const [locationLevel, setLocationLevel] = useState("city"); // "city" or "state"
  ...
  // Build the natural-language query from selections
  function buildQuery() {
  ...
  function replayHistory(item) {
    // Parse history query back into selections if possible
            ...
            <div className={styles.filterGroup}>
              ...
              <div className={styles.selectWrap}>
                <select
                  ...
                  value={queryType}
                  onChange={e => { setQueryType(e.target.value); setResult(null); setError(null); }}
                >
            ...
            <div className={styles.filterGroup}>
              ...
              <div className={styles.selectWrap}>
                <select
                  className={styles.select}
                  value={selectedState}
                  onChange={e => { setSelectedState(e.target.value); setResult(null); setError(null); }}
                >
